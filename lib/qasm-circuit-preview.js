...
import QasmCircuitPanelView from './qasm-circuit-panel-view';
...
export default {
  ...
  activate(state) {
    ...
    this.qasmCircuitPanelView = new QasmCircuitPanelView(state.qasmCircuitPreviewViewState);
    ...
    this.panel = null; // atom.workspace.addRightPanel({
    //   item: this.qasmCircuitPanelView,
    //   visible: true
    // })
    //
    // this.panel.show()
