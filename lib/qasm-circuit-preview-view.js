...
export default class QasmCircuitPreviewView {
  ...
  constructor(serializedState) {
    ...
    QasmClass.message = document.createElement('div');
    QasmClass.image = document.createElement('img');
    ...
    QasmClass.message.classList.add('message');
    ...
    theme_button.onclick = function() {
      ...
      QasmClass.image.src = QasmClass.generateSrc('/Users/tareqdandachi/delete', 'qcp', QasmClass.is_dark, 'png');
    ...
    QasmClass.content.appendChild(QasmClass.image);
    QasmClass.content.appendChild(QasmClass.message);
  ...
  requestImage(QasmClass, hard=false) {
    ...
    new (require("atom").BufferedProcess)({
      ...
      stdout: function(out) {
        ...
        QasmClass.message.textContent = out;
