...
export default class QasmCircuitPreviewView {
  ...
  constructor(serializedState) {
    ...
    this.createQasmElements(QasmClass, {"error": "div", "message": "div", "image": "img", "graph_container": "div", "graph": "img", "button_container": "div"})

    QasmClass.elementControllers.graph_selector = document.createElement('select');

    var graph_options = ["bell_state_count", "dag"];
    ...
    for (var i = 0; i < graph_options.length; i++) {
      ...
      QasmClass.elementControllers.graph_selector.appendChild(graph_option);
    }
    ...
    theme_button.onclick = function() {
      ...
      QasmClass.elementControllers.image.src = QasmClass.generateSrc('circuit', QasmClass.is_dark, 'png');

      QasmClass.elementControllers.graph.src = QasmClass.generateSrc(QasmClass.elementControllers.graph_selector.value, QasmClass.is_dark, 'png');
    ...
    tabsToAdd = { "Circuit": QasmClass.elementControllers.image,
                  ...
                  "Graph": QasmClass.elementControllers.graph_container}

    this.addTabs(QasmClass.content, tabsToAdd);

    QasmClass.elementControllers.graph_container.appendChild(QasmClass.elementControllers.graph_selector)
    QasmClass.elementControllers.graph_container.appendChild(QasmClass.elementControllers.graph)
  ...
  requestImage(QasmClass, hard=false) {
    ...
    new (require("atom").BufferedProcess)({
      ...
      stdout: function(out) {
        ...
        QasmClass.elementControllers.graph.src = QasmClass.generateSrc('bell_state_count', QasmClass.is_dark, 'png');
